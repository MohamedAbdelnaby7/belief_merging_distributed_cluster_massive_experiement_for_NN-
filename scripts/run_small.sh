...
echo "=========================================="
echo "Belief Merging Experiment - SMALL"
echo "=========================================="
...
echo "Description: Small scale experiment"
echo "=========================================="
...
python3 complete_distributed_experiment.py \
    --config-file configs/small_config.json \
    --max-workers 32 \
...
with open('configs/small_config.json', 'r') as f:
